...
namespace SongsAndCategories.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var song = await _context.Songs
                .Include(s => s.RelationSongCategory)
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Link,Thumbnail")] Song song, string[] categoriesId)
        {
            if (ModelState.IsValid)
            {
                foreach (var id in categoriesId)
                {
                    ...
                    RelationSongCategory songCategory = new RelationSongCategory
                    {
                        Category = category,
                        Song = song
                    };
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var song = await _context.Songs.Include(s => s.RelationSongCategory)
